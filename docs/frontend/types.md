...
export type GameBasicInfo = Pick<Game, 'game_id' | 'game_name' | 'min_players' | 'max_players'>
...
export type { Player, CreatePlayerRequest, UpdatePlayerRequest } from './player.types'
...
*Documentation des types maintenue en synchronisation avec l'évolution du backend et des besoins frontend.*
